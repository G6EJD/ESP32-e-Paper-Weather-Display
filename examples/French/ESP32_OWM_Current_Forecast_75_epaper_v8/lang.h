...
const String TXT_FORECAST_VALUES = "3-Day Forecast Value";
const String TXT_CONDITIONS = "Conditions";
const String TXT_DAYS = "(Days)";
const String TXT_TEMPERATURES = "Temperatures";
...
const String TXT_PRECIPITATION_SOON = "Precipitation (soon)";
...
//Sun
const String TXT_SUNRISE = "Sun Rise: ";
const int TXT_X_SUNSET = 16; 
const String TXT_SUNSET  = "     Set: ";
