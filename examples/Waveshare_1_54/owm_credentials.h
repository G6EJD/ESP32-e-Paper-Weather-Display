...
const char server[] = "api.openweathermap.org";            // default
String apikey       = "your_API_key";                      // It's free to get an API key, but don't take more than 60 readings/minute!
                                                           // Example/test API call for weather data
                                                           // http://api.openweathermap.org/data/2.5/weather?q=Melksham,UK&APPID=your_OWM_API_key&mode=json&units=metric&cnt=1
                                                           // Example/test API call for forecast data
                                                           // http://api.openweathermap.org/data/2.5/forecast?q=Melksham,UK&APPID=your_OWM_API_key&mode=json&units=metric&cnt=40
//Set your location according to OWM locations
String CityID           = "2642786";                       // Go to https://openweathermap.org/ Type the nearest city or town name into the search field and click the search button.
                                                           // Locate your city in the search results, and click on its name. The City ID can be found in your browser's address bar.
...
int daylightOffset_sec  = 3600;                            // In the UK DST is +1hr or 3600-secs, other countries may use 2hrs 7200 or 30-mins 1800 or 5.5hrs 19800 Ahead of GMT 
                                                           // use + offset behind - offset
