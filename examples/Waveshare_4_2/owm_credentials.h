...
String Country       = "GB";                            // Your country, find your (nearest) city and the country code is displayed 
                                                        // Find your_ISO-3166-1_two-letter_country_code
                                                        // https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codesString Language      = "EN";                            // NOTE: Only the weather description (not used) is translated by OWM
