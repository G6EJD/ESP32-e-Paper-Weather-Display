...
const char* ssid     = "flowernetwork";
const char* password = "0805014600";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "607027ee2f628182b89940201f77a56d";        // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String City             = "BARI";                      // Your home city See: http://bulk.openweathermap.org/sample/
String Country          = "IT";                            // Your _ISO-3166-1_two-letter_country_code country code, on OWM find your nearest city and the country code is displayed
