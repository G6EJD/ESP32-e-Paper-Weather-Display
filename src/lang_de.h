...
const String TXT_LOCAL_HISTORY_VALUES = "Verlauf";
const String TXT_MQTT_HISTORY_VALUES  = "Verlauf";
...
const String TXT_WIFI_OFF = "WLAN nicht verbunden";
const char* TXT_UPDATED   = "aktualisiert:";

//Wind
const String TXT_WIND_SPEED_DIRECTION = "Windgeschw./Richtung";
